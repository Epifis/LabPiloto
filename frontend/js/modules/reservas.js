...
export async function verDetallesReserva(id) {
  try {
    ...
    const reserva = await api.get(`${API_ENDPOINTS.reservas.listar}/${id}`);
...
export async function aprobarReserva(id) {
  try {
    await api.put(`${API_ENDPOINTS.reservas.listar}/${id}/aprobar`);
...
export async function rechazarReserva(id) {
  ...
  try {
    await api.put(`${API_ENDPOINTS.reservas.listar}/${id}/rechazar`);
